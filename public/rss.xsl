  ...
  <xsl:template match="/">
    <html lang="en">
      <head>
        ...
        <style>
          @font-face {
            font-family: 'Berkeley Mono v2 Variable';
            src: local('Berkeley Mono v2 Variable');
          }
          ...
          *::after {
          ...
          html {
            font-family: 'Berkeley Mono v2 Variable', ui-monospace, SFMono-Regular, Monaco, Consolas, monospace;
            font-size: 16px;
            font-weight: 300;
            line-height: 1.65;
